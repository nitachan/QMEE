...
Note: You will need to run the previous assignemnt script `QMEE/BIO708_assignment2_datacleaning_NC.R` to generate the RDS file to run this new script.
